...
int test_graphics()
{
  ...
  while (1)
  {
    ...
    microGraphicsDrawRect(microCanvasGetTextureId(canvasId), 0, 0, 400, 400, 100, 0, 200, 200, 1.0, 1.0, 1.0, 1.0);
    //microGraphicsDrawRect(texid, 0, 0, texWidth, texHeight, 10, 10, 40, 40, 1.0, 1.0, 1.0, 1.0);
