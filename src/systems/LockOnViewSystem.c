...
{
  CLockOnView* components_lock_on_view = (CLockOnView*)microECSComponentsGet(cid_lock_on_view); 
  const unsigned int components_count = microECSComponentsCount(cid_lock_on_view);
